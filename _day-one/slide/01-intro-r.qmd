...
Connect to our [pad](https://bit.ly/ubep-rws-pad-ed2)(<https://bit.ly/ubep-rws-pad-ed2>) and:
...
ME: Connect to the Day-1 project in RStudio cloud (<https://bit.ly/ubep-rws-rstudio>): script `01-base.R`
...
ME: Connect to the Day-1 project in RStudio cloud (<https://bit.ly/ubep-rws-rstudio>): script `02-vectors.R`
...
ME: Connect to the Day-1 project in RStudio cloud (<https://bit.ly/ubep-rws-rstudio>): script `03-matrices_dataframes.R`
...
1.  Run the code below and compare data frames and tibbles trying exploring its structure, subsetting it, or extracting some column, rows, value(s). You can use `05-packages.R`. Which difference do you see? Write your opinions in the pad (we will discuss in a different lesson).
