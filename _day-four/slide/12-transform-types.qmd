...
1.  Under the sections `4.2. Ex28 Ex29` of the pad, write (in a new line) your answer to the questions reported.
...
1.  Before to evaluate it, in the pad, under the section `4.2. Ex30`, write (in a new line) how can you match all files names that are R scripts (i.e., ending with `.r` or `.R`)? Report you option for a regular expression.
