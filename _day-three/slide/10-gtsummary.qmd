...
1.  Under the section `4.1. Ex 25`, answer to the questions with an x next to the correct answer.

2.  Open the script `16-tbl_cross.R`, and follow the instruction step by step.
...
1.  Under the section `4.1. Ex26 Ex 27`, answer to the questions with an x next to the correct answer.

3.  Then, open the script `17-tbl_uvregression.R` and follow the instruction step by step.

4.  Then, open the script `18-merge.R` and follow the instruction step by step.
