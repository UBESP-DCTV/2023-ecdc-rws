...
1.  Open the script `07-ggplot.R` and follow the instruction step by step to create a plot and upload it on the pad.
...
YOU: Connect to our Day2 project in RStudio cloud (<https://bit.ly/ubep-rws-rstudio>) and save your plot using an R instruction instead of the RStudio GUI.

ME: Connect to the `course-scripts` project in RStudio cloud (<https://bit.ly/ubep-rws-rstudio>): script `07-ggplot.R` (from complete)
