...
### 2. \[35'\] Infrastructures[^2]

-   \[15'\] R projects

-   \[15'\] Local environments

-   \[5'\] Files organization (dev/ folder)
...
### 3a. \[75'\] Pipe(s) and visualization [^3]

-   \[10'\] Intro to data analysis cycle loop

-   \[10'\] Function composition and pipes
...
### 3b. \[10'\] Pipe(s) and visualization [^4]

-   \[10'\] Intro to `{ggplot2}`

    -   \[5'\] Scales, Facets, Labels, and Themes

    -   \[5'\] Saving plots

### 4a. \[20'\] Import and cleaning

-   \[20'\] Base and Tidy, and `rio`[^5] [^6]
...
### 4b. \[50'\] Import and cleaning

-   \[50'\] Headers, var names, and missing data
...
### 5. (a) \[10'\] Transform -- manage shape[^7]

-   \[10'\] Tidy format


### 5. (b) \[40'\] Transform -- manage dataset[^8]
...
-   \[40'\] mutate (grouped) data contents & across
...
### 6. \[55'\] Modeling (summary statistics tables)[^10]
...
### 6. \[50'\] Modeling (summary statistics tables)[^10]
...
### 5. (c) \[30'\] Transform -- manage main types[^9]

-   \[15'\] factors

-   \[15'\] dates/datetimes

-   (\[30'\] strings (optional if time allows))
