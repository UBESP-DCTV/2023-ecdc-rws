...
### 1. \[120'\] Basic R and RStudio:

- \[15'\] Math and Logic

- \[15'\] Base R syntax

- \[20'\] Base data structures
  - Vectors (`logical`, `integer`, `double`, `character`, `factors`, `Date`, `POSIXct`)
  - Lists (`list`, `data frame`/`tibble`)

- \[20'\] Subsetting and Extractions

- \[20'\] Control flow (`if`, `else`, `for`)

- \[15'\] Functions (named and anonymous)

- \[15'\] Packages, Tidyverse ecosystem, style, and perspectives
...
### 3a. \[90'\] Pipe(s) and visualization [^2]

-   \[15'\] Intro to data analysis cycle loop
...
### 3b. \[50'\] Pipe(s) and visualization [^2]
...
-   \[50'\] Intro to `{ggplot2}`
    ...
    -   \[15'\] Themes and other components
...
-   \[20'\] Base and Tidy, and `rio`[^4] [^5]

-   \[20'\] Headers, var names, and missing data
...
### 5. (a) \[60'\] Transform -- manage shape[^6]
...
### 5. (b) \[60'\] Transform -- manage dataset[^8]
...
### 5. (c) \[45'\] Transform -- manage formats[^7]
...
### 6. \[90'\] Modeling (summary statistics tables)[^9]
...
[^7]: pkgs: {dplyr}, {lubridate}, {stringr}, {glue}
