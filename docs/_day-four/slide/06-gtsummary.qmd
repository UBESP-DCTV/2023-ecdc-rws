...
1.  Under the section `4.1. Ex23 Ex24`, answer to the questions with an x next to the correct answer.

2.  Open the script `15-tbl_summary.R` and follow the instruction step by step.
...
1. Under the section `4.1. Ex25 Ex26 Ex 27`, answer to the questions with an x next to the correct answer.


3. Then, open the script `16-tbl_cross.R` and follow the instruction step by step.

4.  Then, open the script `17-tbl_uvregression.R` and follow the instruction step by step.

5.  Then, open the script `18-merge.R` and follow the instruction step by step.
