...
2. Which argument of `tbl_summary` you should use to stratify the table by a variable?
...
1.   Under the section `4.2. Ex27`, answer to the following question with an x next to the correct answer.
