...
::: columns
::: {.column width="50%"}
-   close and reopen you projects without losing your script (you will lose your R environmental object you have created with your code, but you can always restore it re-running your scripts!).
