...
-   **Session 1:** 2024 February 26, 1:30-5:30 p.m. CET (Click [here](https://www.timeanddate.com/worldclock/fixedtime.html?msg=UBEP%27s+R+Course+for+Supervisors+-+Day-1&iso=20240129T1330&p1=5654&ah=4) for your timezone).[^2]

-   **Session 2:** 2024 February 29, 1:30-5:30 p.m. CET (Click [here](https://www.timeanddate.com/worldclock/fixedtime.html?msg=UBEP%27s+R+Course+for+Supervisors+-+Day-2&iso=20240201T1330&p1=5654&ah=4) for your timezone).

-   **Session 3:** 2024 March 04, 1:30-5:30 p.m. CET (Click [here](https://www.timeanddate.com/worldclock/fixedtime.html?msg=UBEP%27s+R+Course+for+Supervisors+-+Day-3&iso=20240205T1330&p1=5654&ah=4) for your timezone).

-   **Session 4:** 2024 March 07, 1:30-5:30 p.m. CET (Click [here](https://www.timeanddate.com/worldclock/fixedtime.html?msg=UBEP%27s+R+Course+for+Supervisors+-+Day-4&iso=20240208T1330&p1=5654&ah=4) for your timezone).
...
-   **Interactive**: questions for you to answer.
    ...
    Connect to our [pad](https://bit.ly/ubep-rws-pad-ed2) and present yourself.[^3]
    :::
...
[^3]: <https://bit.ly/ubep-rws-pad-ed2>
...
-   Free for you to use within the course workspace.[^4]

-   Once you join the workspace, you can enter the R project provided for the day.

-   The environment is already set for you

[^4]: You need a free account to join workspaces. If you didn't have one already, joining our workspace will first redirect to the sign up page. Link to join: [https://bit.ly/ubep-rws[-rstudio-registration-only]{style="color:darkorange;"}](https://bit.ly/ubep-rws-rstudio-registration-only).
